...
const MainPage = () => {
  ...
  return (
    <div className="min-h-[1043px] min-w-[1920px] bg-cover bg-hero_image bg-no-repeat bg-center text-center relative flex items-center justify-center">
      {showModal && (
      ...
      >
        ...
        >
          <svg
            ...
            stroke="currentColor"
            className={`rotate-0 ${isArrowHovered ? "cursor-pointer" : ""}`}
          >
            <line
              x1="11.7052"
              y1="4.77742"
